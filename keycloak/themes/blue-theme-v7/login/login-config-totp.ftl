...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="${xKeycloakify.resourcesPath}/dist/favicon.svg">
  <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-m5VqpcqY.js"></script>
  <link rel="stylesheet" crossorigin="" href="${xKeycloakify.resourcesPath}/dist/assets/index-BsmvokvZ.css">
</head>
