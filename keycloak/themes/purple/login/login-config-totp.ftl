...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
    ...
    <#if requiredActions?? && requiredActions?is_enumerable>
      ...
      <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-CvdZAVXJ.js"></script>
      <link rel="stylesheet" crossorigin="" href="${xKeycloakify.resourcesPath}/dist/assets/index-B49ojom_.css">
    </head>
