...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
  ...
  <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-v9KB_nYn.js"></script>
  <link rel="stylesheet" crossorigin="" href="${xKeycloakify.resourcesPath}/dist/assets/index-CXeZ8lcc.css">
</head>
